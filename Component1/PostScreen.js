...
import {getAllUsers, getSingleUser, getAllCollegues, getposts, addpost, deletepost, addpostwithImage} from '../redux/actions/authAction'
    ...
    return (
      ...
      <ScrollView>
       ...
       <View style={{marginTop:HEIGHT_MIN/50, flex:10 }}>
            ...
            <View style={{marginHorizontal:7, borderRadius:8, margin:4, position:'relative'}}>
                <TextInput
                ...
                />
                <Icon onPress={()=> this.selectphoto()} name="image" size={30} style={{position:'absolute', bottom:3, right:15}}/>
            </View>
              ...
              
              {
                this.state.postImage == null ? (
                  <View>
                    ...
                    <View style={{}}>
                    <Image source={this.state.postImage} style={{ marginBottom:10,height:TEXTSIZE,width:TEXTSIZE, marginTop:20, borderWidth:1}}/>
                  </View>
